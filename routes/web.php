...
use App\Http\Controllers\Automation\ScheduledAutomationController;
...
Route::prefix('{current_team}/automation')
    ...
    ->group(function () {
        ...
        Route::get('scheduled-automations', [ScheduledAutomationController::class, 'index'])->name('scheduled-automations.index');
        Route::get('scheduled-automations/{scheduled_automation}', [ScheduledAutomationController::class, 'show'])->name('scheduled-automations.show');
        Route::post('scheduled-automations', [ScheduledAutomationController::class, 'store'])->name('scheduled-automations.store');
        Route::patch('scheduled-automations/{scheduled_automation}', [ScheduledAutomationController::class, 'update'])->name('scheduled-automations.update');
        Route::delete('scheduled-automations/{scheduled_automation}', [ScheduledAutomationController::class, 'destroy'])->name('scheduled-automations.destroy');
